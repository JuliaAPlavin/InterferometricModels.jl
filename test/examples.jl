...
image(0±15, 0±15, comp_convolved, colormap=Reverse(:inferno))
...
let
	fig, ax, plt = image(convolve(ustrip(mod), b), colormap=Reverse(:inferno), colorscale=SymLog(1e-3))
